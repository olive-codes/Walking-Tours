...
class FenceMgr {
    ...
    FenceMgr(final MapsActivity mapsActivity) {
        ...
        //fenceDownloader.downloadRoutes(mapsActivity);
    }
    ...
    void addFence(FenceData fd) {
        ...
        Address = fd.getBuildingAddress();
        Body = fd.getBuildingDescription();
        Image = fd.getBuildingImage();
        ...
        //geofencePendingIntent.getClass().
